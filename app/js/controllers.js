...
//data;
        ...
        $scope.scrollToBackGround = function (image, ind) {
            $scope.listpositionBackGround = {left: (IMAGE_WIDTH * ind * -1) + "px"};
            $scope.selectedBackGround = image;
        };
        // Scroll to appropriate position based on image index and width
        $scope.scrollToForeGround = function (image, ind) {
            $scope.listpositionForeGround = {left: (IMAGE_WIDTH * ind * -1) + "px"};
            $scope.selectedForeGround = image;
        };
    }])
